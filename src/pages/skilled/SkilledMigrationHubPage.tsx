          ...
          <div style={{ display: 'grid', gridTemplateColumns: '360px 1fr', gap: 56, alignItems: 'start' }} className="hero-grid">
            ...
            <div>
              <div style={{ background: 'rgba(245,161,36,0.08)', border: '1.5px solid rgba(245,161,36,0.3)', borderRadius: 10, padding: '10px 16px', marginBottom: 16 }}>
                <span style={{ fontSize: 12, fontWeight: 700, color: '#0d1632' }}>[DRAFT]</span>
                <span style={{ fontSize: 12, color: '#0d1632', marginLeft: 8 }}>Replace with verified DHA data before launch.</span>
              </div>
