            ...
            <div style={{ position: 'relative' }} onMouseEnter={() => openPanel('__practice__')}>
              <button
                ...
                style={{
                  ...
                  fontFamily: 'Inter, system-ui, sans-serif', textTransform: 'uppercase', marginLeft: 6,
                }}>
                ...
                <div
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 0 }}>
                    ...
                    <div style={{ padding: '24px 20px 20px', borderRight: '1px solid #f0f2f7' }}>
                      <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.14em', textTransform: 'uppercase', color: GOLD, marginBottom: 10, fontFamily: 'Inter, system-ui, sans-serif' }}>The Practice</div>
                      ...
                      {[
                        ...
                        <a key={l.label} href={l.href ?? '#'}
                          ...
                          <div>
                            <div style={{ fontSize: 13, fontWeight: l.emph ? 700 : 600, color: l.emph ? NAVY : '#1E1E2A', fontFamily: 'Inter, system-ui, sans-serif', lineHeight: 1.3 }}>{l.label}</div>
                            <div style={{ fontSize: 11, color: '#9890b0', fontFamily: 'Inter, system-ui, sans-serif', marginTop: 2, lineHeight: 1.4 }}>{l.desc}</div>
                          </div>
                        </a>
                      ))}
                    </div>
                    ...
                    {/* Column 2: Free Tools */}
                    <div style={{ padding: '24px 20px 20px', borderRight: '1px solid #f0f2f7' }}>
                      <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.14em', textTransform: 'uppercase', color: GOLD, marginBottom: 10, fontFamily: 'Inter, system-ui, sans-serif' }}>Free Tools</div>
                      <div style={{ height: 1, background: '#f0f2f7', marginBottom: 12 }} />
                      {[
                        ...
                        <a key={l.label} href="#"
                          ...
                          <div>
                            <div style={{ fontSize: 13, fontWeight: 600, color: '#1E1E2A', fontFamily: 'Inter, system-ui, sans-serif', lineHeight: 1.3 }}>{l.label}</div>
                            <div style={{ fontSize: 11, color: '#9890b0', fontFamily: 'Inter, system-ui, sans-serif', marginTop: 2, lineHeight: 1.4 }}>{l.desc}</div>
                          </div>
                        </a>
                      ))}
                      ...
                      <a href="#" onClick={e => { e.preventDefault(); navigate('tools'); closeNav() }}
                        ...
                        <span style={{ fontSize: 12, fontWeight: 600, color: NAVY, fontFamily: 'Inter, system-ui, sans-serif' }}>All tools</span>
                    ...
                    <div style={{ padding: '24px 20px 20px' }}>
                      <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.14em', textTransform: 'uppercase', color: GOLD, marginBottom: 10, fontFamily: 'Inter, system-ui, sans-serif' }}>Resources</div>
                      <div style={{ height: 1, background: '#f0f2f7', marginBottom: 12 }} />
                      {[
                  ...
                  <div style={{ borderTop: '1px solid #f0f2f7', padding: '10px 20px', display: 'flex', alignItems: 'center', gap: 16, background: '#fafbfe', borderRadius: '0 0 14px 14px' }}>
                    <span style={{ display: 'flex', alignItems: 'center', gap: 5, padding: '3px 10px', borderRadius: 100, background: `${NAVY}0e`, border: `1px solid ${NAVY}18`, fontSize: 10, fontWeight: 700, color: NAVY, fontFamily: 'Inter, system-ui, sans-serif', letterSpacing: '0.06em', whiteSpace: 'nowrap' }}>
                    ...
                    <a href="https://portal.mara.gov.au/search-the-register-of-migration-agents/" target="_blank" rel="noopener noreferrer"
                      style={{ fontSize: 11, color: '#9ca3af', textDecoration: 'none', fontFamily: 'Inter, system-ui, sans-serif', whiteSpace: 'nowrap', transition: 'color 0.12s' }}
                    ...
                    <a href="tel:1300644728"
                      style={{ display: 'flex', alignItems: 'center', gap: 5, fontSize: 11, fontWeight: 600, color: NAVY, textDecoration: 'none', fontFamily: 'Inter, system-ui, sans-serif', whiteSpace: 'nowrap', transition: 'color 0.12s' }}
                      onMouseEnter={e => { (e.currentTarget as HTMLElement).style.color = GOLD }}
                  ...
                  <div key={cat.heading} style={{ paddingLeft: 24, borderLeft: '1px solid #f0f0f4', display: 'flex', flexDirection: 'column', gap: 0 }}>
                    ...
                    <div style={{ flex: 1, background: GRADIENT_CARD_LIGHT, borderRadius: 14, border: '1px solid #c8d8f0', borderTop: `3px solid ${GOLD}`, boxShadow: '0 4px 20px rgba(27,43,94,0.10)', padding: '20px 18px', display: 'flex', flexDirection: 'column', gap: 0, marginBottom: 28, position: 'relative', overflow: 'hidden' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
                        ...
                        <div>
                          <div style={{ fontSize: 11, fontWeight: 800, color: GOLD, fontFamily: 'Inter, system-ui, sans-serif', letterSpacing: '0.08em', textTransform: 'uppercase' }}>MARA REGISTERED</div>
                          <div style={{ fontSize: 10, color: '#64748b', fontFamily: 'Inter, system-ui, sans-serif', marginTop: 1 }}>MARN 2619467</div>
                        </div>
                      </div>
                      {/* Heading + subline */}
                      <div style={{ fontSize: 15, fontWeight: 700, color: NAVY, fontFamily: 'Inter, system-ui, sans-serif', lineHeight: 1.3, marginBottom: 4 }}>MARA-Registered Migration Agent</div>
                      <div style={{ fontSize: 12, color: '#475569', fontFamily: 'Inter, system-ui, sans-serif', lineHeight: 1.55, marginBottom: 16 }}>Navpreet Aulakh — 14 years helping skilled workers, students and families move to Australia.</div>
                      {/* Contact rows */}
                      {[
                        ...
                        <a key={c.label} href={c.href} style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8, textDecoration: 'none', transition: 'color 0.12s' }}
                          ...
                          <span style={{ fontSize: 12, color: NAVY, fontFamily: 'Inter, system-ui, sans-serif', fontWeight: 500 }}>{c.label}</span>
                        </a>
                      ))}
                      {/* Divider + link groups */}
                      <div style={{ borderTop: '1px solid #dde6f5', marginTop: 12, paddingTop: 12 }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 10px' }}>
                          {/* Free Tools */}
                          <div>
                            <div style={{ fontSize: 9, fontWeight: 800, letterSpacing: '0.14em', textTransform: 'uppercase', color: GOLD, marginBottom: 6, fontFamily: 'Inter, system-ui, sans-serif' }}>Free Tools</div>
                            {[
                              ...
                              <a key={l.label} href="#"
                                ...
                                style={{ display: 'flex', alignItems: 'center', gap: 5, minHeight: 28, textDecoration: 'none', fontFamily: 'Inter, system-ui, sans-serif', fontSize: 12, color: NAVY, fontWeight: 500, transition: 'color 0.12s' }}
                                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.color = GOLD }}
                                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = NAVY }}>
                          ...
                          {/* Resources */}
                          <div>
                            <div style={{ fontSize: 9, fontWeight: 800, letterSpacing: '0.14em', textTransform: 'uppercase', color: GOLD, marginBottom: 6, fontFamily: 'Inter, system-ui, sans-serif' }}>Resources</div>
                            {[
                        ...
                        <a href="https://portal.mara.gov.au/search-the-register-of-migration-agents/" target="_blank" rel="noopener noreferrer"
                          style={{ display: 'inline-flex', alignItems: 'center', gap: 4, marginTop: 10, fontSize: 10, color: '#94a3b8', textDecoration: 'none', fontFamily: 'Inter, system-ui, sans-serif', transition: 'color 0.12s' }}
                          onMouseEnter={e => { (e.currentTarget as HTMLElement).style.color = GOLD }}
                      ...
                      <a href="/book-consultation" onClick={(e) => { e.preventDefault(); navigate('book-consultation') }} style={{ marginTop: 16, backgroundColor: GOLD, color: NAVY_DARK, padding: '11px 16px', borderRadius: 8, textDecoration: 'none', fontSize: 13, fontWeight: 700, fontFamily: 'Inter, system-ui, sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, transition: 'background 0.15s' }}
                ...
                return (
                  <div key={cat.heading} style={{ borderRight: ci < megaCols - 1 ? '1px solid #f0f0f4' : 'none', paddingRight: ci < megaCols - 1 ? 24 : 0, paddingLeft: ci > 0 ? 24 : 0, display: 'flex', flexDirection: 'column' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16, paddingBottom: 14, borderBottom: '1px solid #f0f0f4' }}>
                      ...
                      <span style={{ fontSize: 15, fontWeight: 700, color: '#1E1E2A', fontFamily: 'Inter, system-ui, sans-serif', lineHeight: 1.2 }}>{cat.heading}</span>
                    </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div style={{ flex: 1, minWidth: 0 }}>
                              <div style={{ fontSize: 13.5, fontWeight: 600, color: '#1E1E2A', fontFamily: 'Inter, system-ui, sans-serif', lineHeight: 1.3, marginBottom: 2 }}>
                                {navItem.label}
                                {navItem.code && (
                                  <span style={{ display: 'inline-block', marginLeft: 6, fontSize: 9.5, fontWeight: 700, color: iconColor, backgroundColor: `${iconColor}12`, border: `1px solid ${iconColor}28`, padding: '1px 5px', borderRadius: 4, verticalAlign: 'middle', letterSpacing: '0.04em', fontFamily: 'Inter, system-ui, sans-serif', lineHeight: 1.6 }}>{navItem.code}</span>
                                )}
                              </div>
                              <div style={{ fontSize: 11.5, color: '#9890b0', fontFamily: 'Inter, system-ui, sans-serif', lineHeight: 1.4, overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 1, WebkitBoxOrient: 'vertical' as const }}>{navItem.desc}</div>
                            </div>
                          </a>
                        )
                      })}
                    ...
                    <a href="#" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 12, padding: '10px 12px', backgroundColor: `${iconColor}0d`, borderRadius: 8, border: `1px solid ${iconColor}18`, textDecoration: 'none', transition: 'background 0.12s' }}
                      ...
                      <span style={{ fontSize: 12.5, fontWeight: 600, color: iconColor, fontFamily: 'Inter, system-ui, sans-serif' }}>View All {cat.heading}</span>
            ...
            {navItems.map(item => (
              <div key={item.label} style={{ borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                <button
                  ...
                  style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 0', background: 'none', border: 'none', cursor: 'pointer', color: '#ffffff', fontSize: 16, fontWeight: 600, fontFamily: 'Inter, system-ui, sans-serif' }}
                >
                  {item.label}
                        ...
                        {cat.items.map(navItem => {
                          ...
                          return (
                            <button key={navItem.label}
                              ...
                              style={{ display: 'block', width: '100%', textAlign: 'left', padding: '12px 12px', minHeight: 44, background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.8)', fontSize: 16, fontFamily: 'Inter, system-ui, sans-serif', borderRadius: 6 }}
                            >
                              {navItem.label}
                            </button>
                          )
            ...
            <div style={{ borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
              ...
              {mobileExpanded === '__practice__' && (
                <div style={{ paddingBottom: 16 }}>
                  {/* Group: The Practice */}
                  <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.14em', textTransform: 'uppercase', color: GOLD, marginBottom: 6, paddingLeft: 4, fontFamily: 'Inter, system-ui, sans-serif' }}>The Practice</div>
                  {[
                    { label: 'About the Practice', route: 'about' },
                    { label: 'Contact', route: 'contact' },
                  ].map(l => (
                    <button key={l.label} onClick={() => { navigate(l.route); setMobileOpen(false) }}
                      style={{ display: 'block', width: '100%', textAlign: 'left', padding: '12px 12px', minHeight: 44, background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.8)', fontSize: 15, fontFamily: 'Inter, system-ui, sans-serif', borderRadius: 6 }}>
                      {l.label}
                    </button>
                  ))}
                  {/* Group: Free Tools */}
                  <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.14em', textTransform: 'uppercase', color: GOLD, margin: '10px 0 6px', paddingLeft: 4, fontFamily: 'Inter, system-ui, sans-serif' }}>Free Tools</div>
                  {[
                  ...
                  {/* Group: Resources */}
                  <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.14em', textTransform: 'uppercase', color: GOLD, margin: '10px 0 6px', paddingLeft: 4, fontFamily: 'Inter, system-ui, sans-serif' }}>Resources</div>
                  {[
