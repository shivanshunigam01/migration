...
export function getAllPublicPathEntries(): PublicPathEntry[] {
  ...
  const extras: PublicPathEntry[] = [
    ...
    { path: "terms", title: "Website Terms of Use", category: "Legal" },
    { path: "governance", title: "Governance", category: "Legal" },
    { path: "refund-request", title: "Refund Policy", category: "Legal" },
