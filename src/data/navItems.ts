  ...
  ─────────────────────────────────────────────────────────────────────── */
  {
    ...
    categories: [
      ...
      },
      {
        ...
        viewAllRoute: ROUTE.employerSponsoredVisas,
        items: [
          { label: 'DAMA',                         desc: 'Designated Area Migration Agreements for regional labour shortages.', icon: 'mappin', code: 'DAMA', route: ROUTE.dama },
          { label: 'Labour Market Testing',         desc: 'Advertising and LMT evidence before nominating an overseas worker.', icon: 'clipboard', code: 'LMT', route: ROUTE.labourMarketTesting },
          { label: '482 Conditions & Change of Employer', desc: 'Visa conditions and transferring to a new sponsor.', icon: 'link', code: '482', route: ROUTE.visa482Conditions },
          { label: 'Genuine Position Test',         desc: 'How Home Affairs assesses whether a nominated role is genuine.', icon: 'check', code: 'GPT', route: ROUTE.genuinePositionTest },
          { label: 'Occupation Caveats',            desc: 'Caveats that can exclude an occupation from sponsorship.', icon: 'alert', code: 'Caveat', route: ROUTE.occupationCaveats },
          { label: '191 Permanent Residence (Regional)', desc: 'PR pathway after holding a regional provisional visa.', icon: 'award', code: '191', route: ROUTE.visa191 },
          { label: '400 / 403 / 408 short-stay',    desc: 'Short Stay Specialist, Temporary Work and Temporary Activity visas.', icon: 'plane', code: 'Temp', route: ROUTE.shortStaySpecialist400 },
          { label: '186 skill requirements & list', desc: 'Skills, experience and occupation list for ENS 186.', icon: 'layers', code: '186', route: ROUTE.skill186Requirements },
        ],
      },
  ...
  ─────────────────────────────────────────────────────────────────────── */
  {
    ...
    categories: [
      ...
      },
      {
        ...
        viewAllRoute: ROUTE.skilledMigration,
        items: [
          { label: 'Skilled Regional (887)', desc: 'Permanent residence after living and working in regional Australia.', icon: 'mappin', code: '887', route: ROUTE.skilledRegional887 },
          { label: 'Designated Regional Areas', desc: 'Which postcodes count as regional for 491, 494 and 887.', icon: 'mappin', code: 'Regional', route: ROUTE.regionalAreas },
        ],
      },
      { heading: 'Speak to an Expert', icon: 'phone', isContact: true, items: [] },
    ],
  ...
  ─────────────────────────────────────────────────────────────────────── */
  {
    ...
    categories: [
      ...
      },
      {
        ...
        viewAllRoute: ROUTE.partnerFamilyVisas,
        items: [
          { label: 'Parent Visa (103)', desc: 'Non-contributory permanent parent visa — long queue, lower charge.', icon: 'user', code: '103', route: ROUTE.parentVisa103 },
          { label: 'Contributory Parent (173)', desc: 'Temporary contributory parent stage before 143.', icon: 'user', code: '173', route: ROUTE.contributoryParent173 },
          { label: 'Aged Parent (804)', desc: 'Onshore non-contributory aged parent permanent visa.', icon: 'user', code: '804', route: ROUTE.agedParent804 },
          { label: 'Contributory Aged Parent (884)', desc: 'Temporary onshore contributory aged parent stage.', icon: 'user', code: '884', route: ROUTE.contributoryAgedParent884 },
          { label: 'Aged Dependent Relative', desc: 'Permanent visa for an aged relative dependent on an Australian sponsor.', icon: 'heart', code: 'ADR', route: ROUTE.agedDependentRelative },
          { label: 'Orphan Relative Visa', desc: 'Permanent visa for an orphan relative of an Australian citizen or PR.', icon: 'user', code: 'Orphan', route: ROUTE.orphanRelativeVisa },
        ],
      },
      { heading: 'Speak to an Expert', icon: 'phone', isContact: true, items: [] },
    ],
  ...
  ─────────────────────────────────────────────────────────────────────── */
  {
    ...
    categories: [
      ...
      },
      {
        ...
        viewAllRoute: ROUTE.visitorVisas,
        items: [
          { label: 'Work and Holiday (462)', desc: 'Holiday and work visa for eligible partner countries not covered by 417.', icon: 'plane', code: '462', route: ROUTE.workAndHoliday462 },
          { label: 'Resident Return Visa', desc: 'Travel facilities for permanent residents who need to re-enter Australia.', icon: 'plane', code: 'RRV', route: ROUTE.residentReturnVisa },
        ],
      },
      { heading: 'Speak to an Expert', icon: 'phone', isContact: true, items: [] },
    ],
  ...
  ─────────────────────────────────────────────────────────────────────── */
  {
    ...
    categories: [
      ...
      },
      {
        ...
        viewAllRoute: ROUTE.visaRefusalReview,
        items: [
          { label: 'Natural Justice & s57', desc: 'Invitation to comment on adverse information before a decision.', icon: 'clipboard', code: 's57', route: ROUTE.naturalJusticeS57 },
        ],
      },
      { heading: 'Speak to an Expert', icon: 'phone', isContact: true, items: [] },
    ],
